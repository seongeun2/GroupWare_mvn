   ...
   <div class="approval_color_theme" style="margin-left: 15%; margin-right: 15%;">
      ...
      <div class="w3-row-padding">
         <div class="w3-half">
            ...
            <input class="w3-input w3-border w3-border-black" style="height: 50px; type="text" name="name" value="${vo.name}" readonly >
         </div>
         <div class="w3-quarter">
            <label>부서</label>
            <input class="w3-input w3-border w3-border-black" style="height: 50px; type="text" name="deptName" value="${vo.deptName}" readonly>
         </div>
         <div class="w3-quarter">
            <label>팀명</label>
            <input class="w3-input w3-border w3-border-black" style="height: 50px; type="text" name="teamName" value="${vo.teamName}" readonly>
         </div>
      </div>
